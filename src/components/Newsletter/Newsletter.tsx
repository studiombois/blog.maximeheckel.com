...
const NewsletterCard = () => {
  ...
  /**
 * As for the headline, I think it would be great if it was clear exactly what you're working on so 
 * I can decide if I'm interested in it!

For example, what are your latest projects? How do I know if 
they're really cool? Can you send me some kind of sample when I sign up perhaps? 
Getting more specific would help, in my opinion :)
 */

  /**
  *  updates on my writing/drafts, deep dives into my latest
          projects, curated links, and frontend development tips
  */
  return (
    <NewsLetterCardWrapper>
      ...
      <NewsLetterCardContent>
        ...
        <p>
          ...
          to receive:
          <ul>
            <li>Drafts of upcoming and unreleased blog posts</li>
            <li>
              Deep dives into some of my current React and SwiftUI side projects
              including short commented code snippets
            </li>
            <li>
              Frontend development, serverless and testing tips and how to
              leverage your frontend skills in the iOS development world
            </li>
            <li>
              Curated links of products or resources I found helpful or
              interesting
            </li>
          </ul>
        </p>
